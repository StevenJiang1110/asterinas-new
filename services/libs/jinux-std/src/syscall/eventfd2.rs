use super::{SyscallReturn, SYS_EVENTFD2};
...
impl EventFile {
    ...
    ///
    /// If the new_value exceeds MAX_COUNTER_VALUE, the counter value will not be modified, and
...
impl FileLike for EventFile {
    fn read(&self, buf: &mut [u8]) -> Result<usize> {
        ...
        loop {
            ...
            // Copy value from counter
            buf.copy_from_slice((*counter).as_bytes());
