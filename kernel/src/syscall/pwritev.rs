...
use crate::{fs::file_table::FileDesc, prelude::*, util::IoVecReader};
...
fn do_sys_pwritev(
    ...
    let mut io_vec_reader = IoVecReader::copy_from_user(ctx, io_vec_ptr, io_vec_count)?;
    for reader in io_vec_reader.readers_mut() {
